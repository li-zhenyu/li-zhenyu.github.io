...
[^宣告失踪的体例安排]: `下落不明是指公民离开最后居住地后没有音讯的状况。对于在台湾或者在国外，无法正常通讯联系的，不得以下落不明宣告死亡。【民通意见 26】`，这条规定已经删除。下落不明按一般理解，与住所毫无关系。因此，朱庆育《民法总论》（第二版）、张俊浩《民法学原理》（2024年修订版）等经典教材的安排，已经过时。

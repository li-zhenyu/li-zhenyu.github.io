...
<!-- 事实上，这个案例不仅涉及《民法典》有关欺诈和违约责任的条款，还涉及《消费者权益保护法》关于消费欺诈的惩罚性赔偿规定，并且可以参考指导案例 17 号来权衡法律的具体适用。 -->
:::
...
并且，在**作为裁判理由的法律渊源**一类，指导案例 17 是典型的消费欺诈，它明确了某甲的起诉案由选择：买卖合同纠纷，以及明确了某甲买到的铁手铐在合同因消费欺诈被解除后应该还给某乙。（指导案例）

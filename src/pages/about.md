...
**作者保留著作权，但许可您非以商业方式：在署名的前提下不加修改地加以转载、署名引用、仅为前述转载和引用而翻译。**
...
1. 将网站内容原封不动地混入您的作品。作为引用，您必须：
   ...
   2. 不得以引用内容作为您的作品的主要部分；
   3. 以明确的记号注明其有别于您亲自创作的部分。

署名，是指：

1. 显著地在正文中向读者说明为转载或引用，不得诱导读者认为此内容为您所原创；
2. 显著地在正文中向读者说明其内容的著作权人为本站作者所享有；
...
1. 署名；
2. 非以商业方式作出；
3. 将您的翻译版本仅用于提供引用、转载、及接受本许可协议前提下的再次翻译；
4. 在翻译版本上显著地注明网站内容的来源，或者直接附上原始的网站内容。
...
与网站内容的著作权相关的争议，适用中华人民共和国法律，由中华人民共和国管辖。协议相关争议由协议履行地法院管辖。协议履行地为作者住所地。
